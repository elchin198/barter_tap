...
<main class="flex-1 bg-gray-50 py-6">
 ...
 echo $success; ?></span>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden mb-6">
                <div class="p-5 bg-gray-50 border-b border-gray-200 flex justify-between items-center">
                    ...
                    <div class="<?php
 echo getStatusColor($barter['status']); ?> px-3 py-1 rounded-full text-sm font-medium flex items-center">
                        <i class="<?php
 echo getStatusIcon($barter['status']); ?> mr-1"></i>
                        <?php
 echo translateStatus($barter['status']); ?>
                    </div>
                </div>
                                ...
                                <div class="flex items-start">
                                    <div class="flex-shrink-0 mr-3">
                                        <div class="w-16 h-16 rounded-full bg-gray-200 flex items-center justify-center overflow-hidden">
                                            <?php
 if (!empty($barter['sender_avatar'])): ?>
                                                <img src="<?php
 echo htmlspecialchars($barter['sender_avatar']); ?>" 
                                                     alt="<?php
 echo htmlspecialchars($barter['sender_username']); ?>" 
 ...
 if ($barter['sender_id'] == $current_user['id']): ?>
                                        ...
                                        <?php
 if (!empty($barter['sender_fullname'])): ?>
                                            <p class="text-sm text-gray-600">
                                                <?php
 echo htmlspecialchars($barter['sender_fullname']); ?>
                                            </p>
                                        <?php
 endif; ?>
 ...
 echo $rating_count; ?>)</span>
                                        </div>

                                        <!-- Profil linki -->
                                        <a href="profile.php?id=<?php
 echo $barter['sender_id']; ?>" class="text-primary text-sm hover:underline mt-2 inline-block">
                            ...
                            <div class="border border-gray-200 rounded-lg p-4">
                                <div class="flex items-start">
                                    <div class="flex-shrink-0 mr-3">
                                        <div class="w-16 h-16 rounded-full bg-gray-200 flex items-center justify-center overflow-hidden">
                                            <?php
 if (!empty($barter['recipient_avatar'])): ?>
                                                <img src="<?php
 echo htmlspecialchars($barter['recipient_avatar']); ?>" 
                                                     alt="<?php
 echo htmlspecialchars($barter['recipient_username']); ?>" 
                                                     class="w-full h-full object-cover">
                                            <?php
 else: ?>
                                                <i class="fas fa-user text-gray-400 text-xl"></i>
 ...
 if ($barter['recipient_id'] == $current_user['id']): ?>
                                        ...
                                        <?php
 if (!empty($barter['recipient_fullname'])): ?>
                                            <p class="text-sm text-gray-600">
                                                <?php
 echo htmlspecialchars($barter['recipient_fullname']); ?>
                                            </p>
                                        <?php
 endif; ?>
 ...
 echo $rating_count; ?>)</span>
                                        ...
                                        <!-- Profil linki -->
                                        <a href="profile.php?id=<?php
 echo $barter['recipient_id']; ?>" class="text-primary text-sm hover:underline mt-2 inline-block">
                                            <i class="fas fa-user mr-1"></i> Profili göstər
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="border border-gray-200 rounded-lg overflow-hidden">
                                <div class="p-4 bg-gray-50 border-b border-gray-200">
                                    ...
                                    <p class="text-sm text-gray-600">
                                        <i class="fas fa-user mr-1"></i> <?php
 echo htmlspecialchars($barter['sender_username']); ?> tərəfindən
                                    </p>
                                </div>
                                    ...
                                    <div class="flex flex-col sm:flex-row sm:items-center">
                                        <div class="sm:w-1/3 mb-3 sm:mb-0 sm:mr-4">
                                            <div class="aspect-w-1 aspect-h-1 bg-gray-100 rounded-md overflow-hidden">
                                                <?php
 if (isset($offer_items[$barter['offered_item_id']]['image'])): ?>
                                                    <img src="<?php
 echo htmlspecialchars($offer_items[$barter['offered_item_id']]['image']); ?>" 
                                                         alt="<?php
 echo htmlspecialchars($barter['sender_item_title']); ?>" 
 ...
 echo htmlspecialchars($barter['sender_item_title']); ?>
                                            ...
                                            <?php
 if (!empty($barter['sender_item_description'])): ?>
                                                <p class="text-gray-600 text-sm mb-3 line-clamp-3">
                                                    <?php
 echo nl2br(htmlspecialchars($barter['sender_item_description'])); ?>
                                                </p>
                                            <?php
 endif; ?>

                                            <a href="item.php?id=<?php
 echo $barter['sender_item_id']; ?>" class="text-primary text-sm hover:underline inline-flex items-center">
                            ...
                            <div class="border border-gray-200 rounded-lg overflow-hidden">
                                <div class="p-4 bg-gray-50 border-b border-gray-200">
                                    ...
                                    <p class="text-sm text-gray-600">
                                        <i class="fas fa-user mr-1"></i> <?php
 echo htmlspecialchars($barter['recipient_username']); ?> tərəfindən
                                    </p>
                                </div>
                                ...
                                <div class="p-4">
                                    <div class="flex flex-col sm:flex-row sm:items-center">
                                        <div class="sm:w-1/3 mb-3 sm:mb-0 sm:mr-4">
                                            <div class="aspect-w-1 aspect-h-1 bg-gray-100 rounded-md overflow-hidden">
                                                <?php
 if (isset($offer_items[$barter['wanted_item_id']]['image'])): ?>
                                                    <img src="<?php
 echo htmlspecialchars($offer_items[$barter['wanted_item_id']]['image']); ?>" 
                                                         alt="<?php
 echo htmlspecialchars($barter['recipient_item_title']); ?>" 
                                                         class="object-cover w-full h-full">
                                                <?php
 else: ?>
                                                    <div class="flex items-center justify-center h-full">
 ...
 echo htmlspecialchars($barter['recipient_item_title']); ?>
                                            ...
                                            <?php
 if (!empty($barter['recipient_item_description'])): ?>
                                                <p class="text-gray-600 text-sm mb-3 line-clamp-3">
                                                    <?php
 echo nl2br(htmlspecialchars($barter['recipient_item_description'])); ?>
                                                </p>
                                            <?php
 endif; ?>

                                            <a href="item.php?id=<?php
 echo $barter['recipient_item_id']; ?>" class="text-primary text-sm hover:underline inline-flex items-center">
                                                <i class="fas fa-eye mr-1"></i> Əşyanı göstər
                                            </a>
                                        </div>
                                    </div>
                    ...
                    <!-- Barter hərəkətləri -->
                    <?php
 if ($barter['status'] === 'pending' && $barter['recipient_id'] == $current_user['id']): ?>
 ...
 echo csrf_field(); ?>
                                        ...
                                        <input type="hidden" name="barter_id" value="<?php
 echo $barter_id; ?>">
 ...
 echo $sender_confirmed ? 'bg-green-500' : 'bg-gray-300'; ?> flex items-center justify-center text-white">
                                        <i class="<?php
 echo $sender_confirmed ? 'fas fa-check' : 'fas fa-user'; ?>"></i>
                                    </div>
                                    <div class="ml-2">
                                        <span class="text-sm font-medium"><?php
 echo htmlspecialchars($barter['sender_username']); ?></span>
                                        <span class="text-xs text-gray-500 block">
                                            <?php
 echo $sender_confirmed ? 'Təsdiqlənib' : 'Gözlənilir'; ?>
                                        </span>
                                    </div>
                                </div>

                                <div class="w-16 h-1 bg-gray-200 mx-2 relative">
                                    <div class="absolute inset-0 bg-green-500" style="width: <?php
 echo ($sender_confirmed && $recipient_confirmed) ? '100%' : ($sender_confirmed || $recipient_confirmed ? '50%' : '0%'); ?>%;"></div>
                                </div>

                                <div class="flex-1 flex items-center">
                                    <div class="w-8 h-8 rounded-full <?php
 echo $recipient_confirmed ? 'bg-green-500' : 'bg-gray-300'; ?> flex items-center justify-center text-white">
                                        <i class="<?php
 echo $recipient_confirmed ? 'fas fa-check' : 'fas fa-user'; ?>"></i>
                                    </div>
                                    <div class="ml-2">
                                        <span class="text-sm font-medium"><?php
 echo htmlspecialchars($barter['recipient_username']); ?></span>
                                        <span class="text-xs text-gray-500 block">
                                            <?php
 echo $recipient_confirmed ? 'Təsdiqlənib' : 'Gözlənilir'; ?>
                                        </span>
                                    </div>
                                </div>
                            </div>
 ...
 if (empty($user_ratings)): ?>
                                <div class="bg-yellow-50 border border-yellow-200 text-yellow-800 p-4 rounded-md mb-4">
                                    ...
                                    <a href="user-rating.php?user=<?php
 echo $other_user_id; ?>&barter=<?php
 echo $barter_id; ?>" class="font-medium underline">
                                        İndi qiymətləndirin
                                    </a>
                                </div>
                            <?php
                                                ...
                                                <div class="flex items-center justify-between">
                                                    <div>
                                                        ...
                                                        <span class="text-sm text-gray-500 ml-2">
                                                            (<?php
 echo timeAgo($rating['created_at']); ?>)
                                                        </span>
                                                    </div>
 ...
 for ($i = 1; $i <= 5; $i++): ?>
                                                            <i class="<?php
 echo $i <= $rating['rating'] ? 'fas' : 'far'; ?> fa-star text-yellow-400 ml-0.5"></i>
                                                        <?php
 endfor; ?>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="flex items-start">
                                            <div class="flex-shrink-0 mr-3">
                                                <div class="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center overflow-hidden">
                                                    <?php
 if (!empty($rating['rater_avatar'])): ?>
                                                        <img src="<?php
 echo htmlspecialchars($rating['rater_avatar']); ?>" 
                                                             alt="<?php
 echo htmlspecialchars($rating['rater_username']); ?>" 
                                                             class="w-full h-full object-cover">
                                                    <?php
 else: ?>
 ...
 echo htmlspecialchars($rating['rater_username']); ?></span>
                                                        <span class="text-sm text-gray-500 ml-2">
                                                            (<?php
 echo timeAgo($rating['created_at']); ?>)
                                                        </span>
                                    ...
                                    <div class="flex">
                                        ...
                                        <div class="flex-shrink-0 relative z-10">
                                            <div class="w-8 h-8 rounded-full flex items-center justify-center 
                                                <?php
 echo getStatusColor($event['event']); ?>">
                                                <i class="<?php
 echo getStatusIcon($event['event']); ?>"></i>
                                            </div>
                                        </div>
 ...
 if (!empty($event['note'])): ?>
                                                    <div class="mt-2 text-gray-600 text-sm">
                                                        ...
                                                        <?php
 echo nl2br(htmlspecialchars($event['note'])); ?>
                                                    </div>
                                                <?php
 endif; ?>
 ...
 for ($i = 1; $i <= 5; $i++): ?>
                                                            <i class="<?php
 echo $i <= $event['rating'] ? 'fas' : 'far'; ?> fa-star text-yellow-400 mr-0.5 text-sm"></i>
                                                        <?php
 endfor; ?>
                                                    </div>
 ...
 if (!empty($event['comment'])): ?>
                                                        <div class="mt-1 text-gray-600 text-sm">
                                                            ...
                                                            <?php
 echo nl2br(htmlspecialchars($event['comment'])); ?>
                                                        </div>
                                                    <?php
 endif; ?>
                                                <?php
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div class="md:col-span-2">
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                        ...
                        <div class="p-4">
                            <?php
 if ($barter['conversation_id']): ?>
                                <a href="messages.php?conversation=<?php
 echo $barter['conversation_id']; ?>" class="bg-primary hover:bg-primary-700 text-white font-medium py-2 px-4 rounded-md transition-colors inline-flex items-center">
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                        ...
                        <div class="p-4">
                            <ul class="space-y-2">
                                <li>
                                    <a href="profile.php?id=<?php
 echo $other_user_id; ?>" class="text-primary hover:underline flex items-center">
                                        <i class="fas fa-user mr-2"></i> Qarşı tərəfin profilini göstər
                                    </a>
                                </li>
                                <li>
                                    <a href="item.php?id=<?php
 echo $barter['sender_item_id']; ?>" class="text-primary hover:underline flex items-center">
                                        <i class="fas fa-tag mr-2"></i> Təklif edilən əşyanı göstər
                                    </a>
                                </li>
                                <li>
                                    <a href="item.php?id=<?php
 echo $barter['recipient_item_id']; ?>" class="text-primary hover:underline flex items-center">
                                        <i class="fas fa-tag mr-2"></i> İstənilən əşyanı göstər
                                    </a>
                                </li>

                                <?php
 if ($barter['status'] === 'completed' && empty($user_ratings)): ?>
                                    <li class="pt-2 border-t border-gray-100">
                                        <a href="user-rating.php?user=<?php
 echo $other_user_id; ?>&barter=<?php
 echo $barter_id; ?>" class="text-green-600 hover:underline flex items-center font-medium">
